...
public class HorizontalDividerItemDecoration extends RecyclerView.ItemDecoration{
     ...
     */
    public HorizontalDividerItemDecoration(Context context, int orientation, int drawableId) {
     ...
     */
    public HorizontalDividerItemDecoration(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
